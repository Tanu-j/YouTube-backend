...
export async function fetchAudio(
    ...
    /*
     * If every client is currently blocked, our block list is stale
     * (e.g. YouTube's enforcement changed back) -- clear it rather than
    ...
    for (
        ...
        try {
            ...
            const options = {
                 ...
                 * CRITICAL:
                 *
                 * Make the signed googlevideo URL
